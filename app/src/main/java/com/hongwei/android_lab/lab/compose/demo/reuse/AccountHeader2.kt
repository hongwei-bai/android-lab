...
@Composable
fun AccountHeader2(
    account: AccountHeaderViewObject2?,
    ...
    Column(
        ...
        if (account == null) {
            Placeholder2(modifier = Modifier.height(120.dp))
        } else {
            Text(
...
@Composable
fun Placeholder2(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .fillMaxWidth()
    ) {
...
data class AccountHeaderViewObject2(
